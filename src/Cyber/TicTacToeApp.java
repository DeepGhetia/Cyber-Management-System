...
public class TicTacToeApp extends Application {
    ...
    String user,email2;
    long brow2,tic2,time2,pong2;
    long ct=System.currentTimeMillis();
    public TicTacToeApp(String username,String email,long tic,long brow,long pong,long time1) {
    user=username;
    brow2=brow;
    tic2=tic;
    time2=time1;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        primaryStage.setTitle("C7yber Tic Tac Toe");
